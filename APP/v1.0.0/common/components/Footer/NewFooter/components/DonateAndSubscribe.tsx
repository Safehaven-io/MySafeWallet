    ...
    return (
      <section className="Donate">
        ...
        <section className="Donate-buttons">
          <CopyToClipboard text={donationAddressMap.VET} onCopy={this.displayMessage}>
            <DonationButton icon={vet} title="VET" />
          </CopyToClipboard>
          <CopyToClipboard text={donationAddressMap.SHA} onCopy={this.displayMessage}>
            <DonationButton icon={sha} title="SHA" />
          </CopyToClipboard>
        </section>
