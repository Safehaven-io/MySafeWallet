...
import logo from 'assets/images/logo-safewallet-white.svg';
import {
  donationAddressMap,
  VERSION,
  knowledgeBaseURL,
        ...
        <footer className="Footer" role="contentinfo" aria-label="footer">
          <div className="Footer-links Footer-section">
            ...
            <div className="Footer-links-links">
              ...
              {/* <NewTabLink href="mailto:press@mysafewallet.io">
          ...
          <div className="Footer-about Footer-section">
            ...
            <div className="Footer-about-links">
              <NewTabLink href="https://safetech.io">SafeTech.io</NewTabLink>
              <NewTabLink href={knowledgeBaseURL}>{translateRaw('FOOTER_SUPPORT')}</NewTabLink>
              {/* <NewTabLink href="https://about.mysafewallet.io">
                {translateRaw('FOOTER_TEAM')}
              </NewTabLink> */}
              <NewTabLink href="https://github.com/safehaven-io/MySafeWallet">
            ...
            <div className="Footer-about-legal">
              <div className="Footer-about-legal-text">
                © {new Date().getFullYear()} SafeWallet, SafeTech Inc.
              </div>
              <div className="Footer-about-legal-text">
