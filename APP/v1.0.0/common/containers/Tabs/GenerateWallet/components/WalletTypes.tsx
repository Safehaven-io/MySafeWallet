      ...
      links: [
        {
          text: translate('ACTION_13', {
            $thing: translateRaw('X_COMET')
          }),
          href: 'https://chrome.google.com/webstore/search/comet'
        }
      ]
    },
    {
      name: translate('X_ARKANE_WALLET'),
      type: 'arkane',
      icon: ArkaneIcon,
      bullets: [
        translate('WALLET_SUGGESTION_ARKANE_1'),
        translate('WALLET_SUGGESTION_ARKANE_2'),
        translate('WALLET_SUGGESTION_ARKANE_3'),
        translate('WALLET_SUGGESTION_ARKANE_4')
      ],
      links: [
        {
          text: translate('ACTION_15'),
          href:
            'https://login.arkane.network/auth/realms/Arkane/login-actions/registration?client_id=Arkane&tab_id=v9WJ29DzebY'
        }
      ]
    }
    // {
      ...
      {!process.env.BUILD_DOWNLOADABLE && (
        <React.Fragment>
          <div className="WalletTypes-download">
            {/* <NewTabLink
              href="https://download.mysafewallet.io"
