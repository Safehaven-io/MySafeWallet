...
* Ledger Support : We are reverse Engineering the Vechain Ledger APP in order to interact with it in a secure manner.
* MySafeWallet Desktop APP releases are upcoming for Windows, Linux and MacOS devices.
* Add VecChainThor Wallet support.
* Add Sync support.
* Safe Node integration : upgrade your node through MySafeWallet.
