...
import ArkaneIcon from 'assets/images/wallets/arkane.svg';
import CometIcon from 'assets/images/wallets/comet.png';
...
const WalletDecrypt = withRouter<Props>(
  class WalletDecryptClass extends Component<RouteComponentProps<{}> & Props, State> {
    ...
    public WALLETS: Wallets = {
      [SecureWalletName.SAFE_HW]: {
        lid: 'X_SAFE_HW',
        description: 'Coming q3 2019!',
        component: TrezorDecrypt,
        initialParams: {},
        unlock: this.props.setWallet,
        helpLink:
          'https://github.com/safehaven-io/MySafeWallet/accessing-your-wallet/how-to-use-your-trezor-with-mycrypto.html'
      },
      ...
      [SecureWalletName.ARKANE_WALLET]: {
        lid: 'X_ARKANE_WALLET',
        icon: ArkaneIcon,
        description: 'ADD_ARKANE_WALLET_DESC',
        component: ArkaneWalletDecrypt,
        initialParams: {},
        unlock: this.props.setWallet,
        helpLink: paritySignerHelpLink
      },
      [SecureWalletName.COMET_WALLET]: {
        lid: 'X_COMET_WALLET',
        icon: CometIcon,
        description: 'ADD_COMET_WALLET_DESC',
        component: CometWalletDecrypt,
        initialParams: {},
        unlock: this.props.setWallet,
        helpLink: paritySignerHelpLink
      },
          ...
          <section className="WalletDecrypt-decrypt-form">
            ...
            >
              <selectedWallet.component
                ...
                isWalletPending={
                  false // this.state.selectedWalletKey === InsecureWalletName.KEYSTORE_FILE
    ...
    private isWalletDisabled = (walletKey: WalletName) => {
      // disable SAFE_HW until it is ready.
      if (walletKey === SecureWalletName.SAFE_HW || walletKey === SecureWalletName.LEDGER_NANO_S) {
        return true;
      }
